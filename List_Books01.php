...
// test to make sure that we selected a radio button ... 
	...
	$query = "SELECT ISBN,BookTitle,BookAuthor,YearOfPublication,Publisher FROM Books LIMIT 10";  
    ...
    echo '<table> <tr><th>Book Title</th><th>Description</th></tr>'; 
